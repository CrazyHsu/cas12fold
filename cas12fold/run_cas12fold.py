...
from cas12fold import cas12fold_pipeline
...
flags.DEFINE_enum_class('cas12folddb_merge_mode', default=Cas12folddbMergeMode.both,
                        enum_class=Cas12folddbMergeMode, help="Modes to merge cas12folddb")
...
def predict_structure(
    ...
    fasta_name: str,
    output_dir_base: str,
    data_pipeline: Union[cas12fold_pipeline.DataPipeline],
  ...
  # Get features.
  t_0 = time.time()
  if cas12folddb_merge_mode == Cas12folddbMergeMode.both:
      cas12folddb_merge_mode = "both"
  elif cas12folddb_merge_mode == Cas12folddbMergeMode.single:
...
def main(argv):
  ...
  if run_multimer_system:
    ...
    template_featurizer = cas12fold_templates.HmmsearchHitFeaturizer(
  ...
  monomer_data_pipeline = cas12fold_pipeline.DataPipeline(
      jackhmmer_binary_path=FLAGS.jackhmmer_binary_path,
      hhblits_binary_path=FLAGS.hhblits_binary_path,
      cas12folddb_database_path=FLAGS.cas12folddb_database_path,
